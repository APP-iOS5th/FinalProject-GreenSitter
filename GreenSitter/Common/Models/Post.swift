...
extension Post {
    static let samplePosts: [Post] = [
        ...
        Post(enabled: true, userId: "", profileImage: "", nickname: "짱아", postType: .lookingForSitter, postTitle: "작은 화분 돌봐드립니다", postBody: "작은 화분도 잘 돌볼 수 있어요...", postImages: [], postStatus: .beforeTrade, location: Location(enabled: true, createDate: Date(), updateDate: Date(), latitude: 37.5665, longitude: 126.9705))
    ]
}
