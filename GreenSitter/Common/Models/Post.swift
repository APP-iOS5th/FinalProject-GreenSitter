...
extension Post {
    static let samplePosts: [Post] = [
        ...
        Post(id: UUID().uuidString, enabled: true, createDate: Date(), updateDate: Date(), userId: "", profileImage: "profileIcon", nickname: "부리부리대마왕1", userLocation: Location.seoulLocation, userNotification: false, postType: .lookingForSitter, postTitle: "가족여행 갈 동안 화분 부탁드립니다.", postBody: "베란다에서 키우는 화분들인데 4박5일 집을 비울 예정...", postImages: ["image1", "image2"], postStatus: .completedTrade, location: Location.sampleLocation),
        ...
        Post(id: UUID().uuidString, enabled: true, createDate: Date(), updateDate: Date(), userId: "", profileImage: "profileIcon", nickname: "화분도사", userLocation: Location.seoulLocation, userNotification: false, postType: .offeringToSitter, postTitle: "화분 전문가의 관리 서비스 제공", postBody: "다양한 화분을 정기적으로 관리해드립니다. 상담 환영합니다.", postImages: ["image4"], postStatus: .beforeTrade, location: Location.seoulLocation),
        
        Post(id: UUID().uuidString, enabled: true, createDate: Date(), updateDate: Date(), userId: "", profileImage: "profileIcon", nickname: "화분도사2", userLocation: Location.incheonLocation, userNotification: false, postType: .lookingForSitter, postTitle: "베란다 화분 관리 부탁드립니다.", postBody: "휴가로 인해 2주 동안 자리를 비웁니다. 베란다에 있는 화분들을 돌봐주세요.", postImages: ["image2", "image3"], postStatus: .beforeTrade, location: Location.incheonLocation),
        
        Post(id: UUID().uuidString, enabled: true, createDate: Date(), updateDate: Date(), userId: "", profileImage: "profileIcon", nickname: "플랜트러버", userLocation: Location.seoulLocation, userNotification: false, postType: .offeringToSitter, postTitle: "다양한 식물의 건강한 성장을 도와드립니다.", postBody: "자주 출장 가시는 분들에게 적합한 맞춤형 식물 관리 서비스입니다.", postImages: ["image1", "image4"], postStatus: .beforeTrade, location: Location.seoulLocation)
    ]
}
