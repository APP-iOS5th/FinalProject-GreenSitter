...
<table align="center">
  <tr>
    ...
    <ul>
      <li style="margin-bottom: 10px;">현재 위치를 기반으로 가까운 곳의 식물 돌봄이를 찾는 / 자원하는 게시물 및 지도 표기</li>
      <li style="margin-bottom: 10px;">실시간 채팅 기능을 통해 사용자 간의 소통 및 약속 만들기 기능 제공</li>
      <li style="margin-bottom: 10px;">돌봄 후기, 레벨을 통한 신뢰도 평가 가능</li>
    </ul>
    </td>
  </tr>
</table>
